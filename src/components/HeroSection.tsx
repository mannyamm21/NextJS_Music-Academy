...
function HeroSection() {
  return (
    <div className="h-auto md:h-[40rem] w-full round-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0">
        <Spotlight
      ...
      />
        <div className="p-4 relative z-10 w-full text-center">
            ...
            <p className="mt-4 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">Dive into our comprehensive music courses and
                ransform your musical journey today. Whether you re a beginner or looking to refine your
                kills, join us to unlock your true potential.</p>
                <div className="mt-4">
                <Link href={"/courses"}>
                <Button
